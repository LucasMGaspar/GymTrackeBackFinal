    ...
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary-500 via-primary-600 to-accent-600 p-6 md:p-8 text-white">
        ...
        <div className="relative">
          ...
          <h1 className="text-2xl md:text-3xl font-bold mb-2">{studentName}</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="card p-5 group hover:shadow-elevated transition-all duration-300">
          ...
          <p className="text-3xl font-bold text-dark-900">{metrics.last28DaysTotal}</p>
          <p className="text-sm text-dark-500 mt-1">Últimos 28 dias</p>
        </div>
        ...
        <div className="card p-5 group hover:shadow-elevated transition-all duration-300">
          ...
          <p className="text-3xl font-bold text-dark-900">{metrics.totalSessions}</p>
          <p className="text-sm text-dark-500 mt-1">Total de Treinos</p>
        </div>
        ...
        <div className="card p-5 group hover:shadow-elevated transition-all duration-300">
          ...
          <p className="text-sm text-dark-500 mt-1">Duração Média</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-lg font-bold text-dark-900">Aderência Semanal</h2>
          ...
          {metrics.last28DaysTotal === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-dark-500">Comece a treinar para ver seu progresso!</p>
            </div>
          ) : (
        ...
        <div className="card p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-lg font-bold text-dark-900">Personal Records</h2>
              <p className="text-sm text-dark-500">Suas maiores cargas 🏆</p>
            </div>
          ...
          {metrics.personalRecords.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-dark-500">Treine com carga para registrar seus PRs!</p>
            </div>
          ) : (
            <div className="space-y-3">
              {metrics.personalRecords.map((pr, index) => (
                <div
                  ...
                  className="flex items-center gap-4 p-3 rounded-xl bg-warning-50 border border-warning-100"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-semibold text-dark-900 truncate">{pr.exercise_name}</p>
                    <p className="text-sm text-dark-500">{formatDate(pr.date)} • {pr.reps}</p>
                  </div>
      ...
      <div className="card p-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center p-5 bg-primary-50 rounded-xl border border-primary-100">
            <p className="text-3xl font-bold text-primary-600">{metrics.totalExercises}</p>
            <p className="text-sm text-dark-600 mt-1">Total de Exercícios</p>
          </div>
          <div className="text-center p-5 bg-success-50 rounded-xl border border-success-100">
            <p className="text-3xl font-bold text-success-600">
              {metrics.totalSessions > 0
                ? Math.round(metrics.totalExercises / metrics.totalSessions)
                : 0}
            </p>
            <p className="text-sm text-dark-600 mt-1">Exercícios por Treino</p>
          </div>
        </div>
      </div>
